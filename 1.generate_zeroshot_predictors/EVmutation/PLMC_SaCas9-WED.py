...
m_path="data/zeroshot_prediction/EVcoupling_alignments/SpCas9/J7RUA5_b0.1.a2m"
couplings_model = CouplingsModel(m_path)
### begin couplings_model.py 
precision="float32"
file_format="plmc_v2"
wtseqs, wtids = read_fasta(os.path.join("data/zeroshot_prediction/EVcoupling/SaCAs9_600-1053.fasta"), return_ids=True)
...
data=pd.read_csv("data/zeroshot_prediction/arDCA/Sa8000_Fitness.csv")
...
data.to_csv("Sa8000_data_EV.csv")
