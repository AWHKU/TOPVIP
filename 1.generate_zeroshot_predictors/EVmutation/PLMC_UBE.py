...
m_path="data/zeroshot_prediction/EVcoupling_alignments/UBE/UBE4B_MOUSE.model_params"
couplings_model = CouplingsModel(m_path)
### begin couplings_model.py 
precision="float32"
file_format="plmc_v2"
wtseqs, wtids = read_fasta("data/zeroshot_prediction/EVcoupling/UBE_wt.fasta", return_ids=True)
...
data=pd.read_csv("data/zeroshot_prediction/EVcoupling/UBE_fitness.data")
...
data.to_csv("UBE_fitness_EV.csv")
