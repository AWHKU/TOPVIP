...
m_path="data/zeroshot_prediction/EVcoupling_alignments/PABP_YEAST.model_params"
couplings_model = CouplingsModel(m_path)
### begin couplings_model.py 
precision="float32"
file_format="plmc_v2"
wtseqs, wtids = read_fasta("data/zer_prediction/EVcoupling/PABP_wt.fasta", return_ids=True)
...
data=pd.read_csv("data/zer_prediction/arDCA/PABP_fitness.data")
...
data.to_csv("PABP_fitness_EV.csv")
