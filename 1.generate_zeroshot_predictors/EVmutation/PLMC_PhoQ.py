...
m_path="data/zeroshot_prediction/EVcoupling_alignments/PhoQ/PhoQ_EVcouplingsModel.model"
couplings_model = CouplingsModel(m_path)
### begin couplings_model.py 
precision="float32"
file_format="plmc_v2"
wtseqs, wtids = read_fasta("data/zer_prediction/EVcoupling/PhoQ_wt.fasta", return_ids=True)
...
data=pd.read_csv("data/zeroshot_prediction/arDCA/PhoQ_fitness.data")
...
data.to_csv("PhoQ_fitness_EV.csv")
