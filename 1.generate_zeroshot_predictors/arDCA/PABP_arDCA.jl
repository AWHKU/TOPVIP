...
fasta_file="data/zeroshot_prediction/EVcoupling_alignments/PABP/PABP_YEAST.a2m"
#fasta_file="/home/athchu/data/seqdesign-pytorch/examples/datasets/sequences/PABP/PABP_homologues_w1.fasta"
...
#Zori = read_fasta_alignment(fasta_file, 1)
### So any lowercase columns in WT will be remove, thus in PABP WT only site 9:90 were dealt with here ###
...
### H=81-element Vector{Vector{Float64}}
### J=81-element Vector{Array{Float64, 3}} 
### p0=21-element Vector
### idxperm 82-element Vector{Int64}
@extract arvar:Z M N q
### Z= 82 x 70771 Matrix, that is the SpCas9 length and the No. of seqs in the alignment
### M=70771
### N=82
### q=21
...
using Pandas
df = read_csv("PABP_arDCA_input.csv")
