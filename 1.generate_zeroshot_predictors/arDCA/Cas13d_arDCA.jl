...
fasta_file="data/zeroshot_prediction/EVcoupling_alignments/Cas13d/Cas13d.a2m"
...
### H=927-element Vector{Vector{Float64}}
### J=927-element Vector{Array{Float64, 3}} 
### p0=21-element Vector
### idxperm 928-element Vector{Int64}
@extract arvar:Z M N q
### Z= 928 x 52 Matrix, that is the SpCas9 length and the No. of seqs in the alignment
### M=52
### N=928
### q=21
...
using Pandas
df = read_csv("data/zeroshot_prediction/arDCA/Cas13d_aaCombo.csv")
AA=df[:mutations] # get AACombo
E=zeros(length(AA))
...
to_csv(output, "Cas13d_arDCA.csv")
