...
fasta_file="data/zeroshot_prediction/EVcoupling_alignments/GFP/GFP_AEQVI.a2m"
...
### H=135-element Vector{Vector{Float64}}
### J=135-element Vector{Array{Float64, 3}} 
### p0=21-element Vector
### idxperm 136-element Vector{Int64}
@extract arvar:Z M N q
### Z= 136×13729 Matrix, that is the no. of AA sites and the No. of seqs in the alignment
### M=13729
### N=136
### q=21
...
using Pandas
df = read_csv("data/zeroshot_prediction/arDCA/GFP_arDCA_input.csv")
...
to_csv(output, "/home/athchu/data/arDCA/GFP_arDCA.csv")
