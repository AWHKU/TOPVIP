...
### MSA 
### load in data
zero_shot="data/clustered_sampling/SaCas9_N289A290N386N387L389L390R392_ZeroShotPreds.csv"
zeroshot="esm_msa1_t12_100M_UR50S-Naive-ColumnUnmasked"
data_zeroshot = pd.read_csv(zero_shot)
data_zeroshot = data_zeroshot.rename({"Combo":"AACombo"}, axis=1)
#### MSA zeor-shot has L887 missing 
data_zeroshot["AACombo"]= "L" + data_zeroshot["AACombo"] 
#### import encoding
encoding_file="SaCas9_georgiev_UnNormalized.npy"
ComboToIndex_file="SaCas9_georgiev_ComboToIndex.pkl"
IndextoCombo_file="SaCas9_georgiev_IndexToCombo.pkl"
...
### CLADE paper recommened min_max_normalisation
### But for gaussian kde, I should use standard-scaled values? 
...
wkdir="data/clustered_sampling/SaCas9_WED-PI_MLDE_Fitness_input"
outprefix="SaCas9_887888889985986988989991_CLADE_MSA_"
...
plt.show()
data_zeroshot.to_csv(wkdir+"SaCas9_887888889985986988989991_MSA_clustered_ZeroShotPreds.csv")
...
### EVmutation
### load in data
zero_shot="data/clustered_sampling/SaCAs9_N888_A889_N985_N986_L988_L989_R991_ZeroShot_EVMUtation.csv"
zeroshot="EvMutation"
data_zeroshot = pd.read_csv(zero_shot)
data_zeroshot = data_zeroshot.rename({"Combo":"AACombo"}, axis=1)
...
Prob, data_zeroshot=cluster_extract_sampling_prob(data_zeroshot, 10, ComboToIndex, IndextoCombo, AACombo, features, "norm")
wkdir="data/clustered_sampling/SaCas9_WED-PI_MLDE_Fitness_input/"
outprefix="SaCas9_887888889985986988989991_CLADE_Evmutation_"
select_AACombo=extract_CLADE_aa(data_zeroshot, 10, Prob, 96, zeroshot, orders=False)
len(select_AACombo)
o=open(wkdir+outprefix+"96.txt", "w")
o.write("\n".join(select_AACombo))
...
data_zeroshot.to_csv(wkdir + "SaCas9_887888889985986988989991_EvMutation_clustered_ZeroShotPreds.csv")

### EvoEF
### reconstructu EvoEF full table
zero_shot="data/clustered_samplingSaCas9_887888889985986988989991_EvoEF.txt"
zeroshot="DDG_stab_1"
data_zeroshot = pd.read_csv(zero_shot)
#### import encoding
encoding_file="SaCas9_georgiev_UnNormalized.npy"
...
wkdir="data/clustered_sampling/SaCas9_WED-PI_MLDE_Fit/"
outprefix="SaCas9_887888889985986988989991_CLADE_EvoEF_"
select_AACombo=extract_CLADE_aa(data_zeroshot, 10, Prob, 96, zeroshot, orders=False)
o=open(wkdir+outprefix+"96.txt", "w")
o.write("\n".join(select_AACombo))
o.close()
...
data_zeroshot.to_csv(wkdir + "SaCas9_887888889985986988989991_CLADE_EvoEF_clustered_ZeroShotPreds.csv")

##arDCA
### reconstructu EvoEF full table
zero_shot="data/clustered_sampling/SaCas9_L887_N888_A889_N985_N986_L988_L989_R991_arDCA.csv"
zeroshot="arDCA_1"
data_zeroshot = pd.read_csv(zero_shot)
#### import encoding
encoding_file="SaCas9_georgiev_UnNormalized.npy"
...
wkdir="data/clustered_sampling/SaCas9_WED-PI_MLDE_Fitness_input/"
outprefix="SaCas9_887888889985986988989991_CLADE_arDCA_"
select_AACombo=extract_CLADE_aa(data_zeroshot, 10, Prob, 96, zeroshot, orders=False)
o=open(wkdir+outprefix+"96.txt", "w")
o.write("\n".join(select_AACombo))
o.close()
...
data_zeroshot.to_csv(wkdir + "SaCas9_887888889985986988989991_CLADE_arDCA_clustered_ZeroShotPreds.csv")



### random 
select_AACombo=list(data_zeroshot.sample(96, axis=0)["AACombo"])
o=open(wkdir+"SaCas9_887888889985986988989991_rep1_random_96.txt", "w")
o.write("\n".join(select_AACombo))
o.close()

select_AACombo=list(data_zeroshot.sample(48, axis=0)["AACombo"])
o=open(wkdir+"SaCas9_887888889985986988989991_rep1_random_48.txt", "w")
o.write("\n".join(select_AACombo))
o.close()

select_AACombo=list(data_zeroshot.sample(24, axis=0)["AACombo"])
o=open(wkdir+"SaCas9_887888889985986988989991_rep1_random_24.txt", "w")
o.write("\n".join(select_AACombo))
o.close()

select_AACombo=list(data_zeroshot.sample(12, axis=0)["AACombo"])
o=open(wkdir+"SaCas9_887888889985986988989991_rep1_random_12.txt", "w")
o.write("\n".join(select_AACombo))
o.close()

select_AACombo=list(data_zeroshot.sample(96, axis=0)["AACombo"])
o=open(wkdir+"SaCas9_887888889985986988989991_rep2_random_96.txt", "w")
o.write("\n".join(select_AACombo))
o.close()

select_AACombo=list(data_zeroshot.sample(48, axis=0)["AACombo"])
o=open(wkdir+"SaCas9_887888889985986988989991_rep2_random_48.txt", "w")
o.write("\n".join(select_AACombo))
o.close()

select_AACombo=list(data_zeroshot.sample(24, axis=0)["AACombo"])
o=open(wkdir+"SaCas9_887888889985986988989991_rep2_random_24.txt", "w")
o.write("\n".join(select_AACombo))
o.close()

select_AACombo=list(data_zeroshot.sample(12, axis=0)["AACombo"])
o=open(wkdir+"SaCas9_887888889985986988989991_rep2_random_12.txt", "w")
o.write("\n".join(select_AACombo))
o.close()

select_AACombo=list(data_zeroshot.sample(96, axis=0)["AACombo"])
o=open(wkdir+"SaCas9_887888889985986988989991_rep3_random_96.txt", "w")
o.write("\n".join(select_AACombo))
o.close()

select_AACombo=list(data_zeroshot.sample(48, axis=0)["AACombo"])
o=open(wkdir+"SaCas9_887888889985986988989991_rep3_random_48.txt", "w")
o.write("\n".join(select_AACombo))
o.close()

select_AACombo=list(data_zeroshot.sample(24, axis=0)["AACombo"])
o=open(wkdir+"SaCas9_887888889985986988989991_rep3_random_24.txt", "w")
o.write("\n".join(select_AACombo))
o.close()

select_AACombo=list(data_zeroshot.sample(12, axis=0)["AACombo"])
o=open(wkdir+"SaCas9_887888889985986988989991_rep3_random_12.txt", "w")
o.write("\n".join(select_AACombo))
o.close()

### fix 20% of data as test data ###
test_AACombo=list(data_zeroshot.sample(260, axis=0)["AACombo"])
o=open(wkdir+"SaCas9_887888889985986988989991_fixed_test_set.txt", "w")
o.write("\n".join(test_AACombo))
o.close()
### no need to remove test set becuase these are zero shot predictions ###

### make fitness.csv for MLDE
Fitness=pd.read_csv("data/MLDE_train_test_datasets/SaCas9_887888887985986988989991_Fitness_norm.csv")
indir="data/clustered_sampling/SaCas9_WED-PI_MLDE_Fitness_input/"
outdir="./SaCas9_887888889985986988989991_Fitnesscsv/"

infiles=os.listdir(indir)
infiles=[i for i in infiles if "SaCas9" in i]
...
for f in infiles:
    ...
    o=temp_tab[["AACombo", "ACAAGT"]]
    o=o.rename({"ACAAGT":"Fitness"}, axis=1)
    o=o.dropna(axis=0, how='any')
    outfile=infile.replace(".txt", "_ACAAGT.csv")
    o.to_csv(outdir+outfile, index=False)
    o=temp_tab[["AACombo", "GGTGGT"]]
    o=o.rename({"GGTGGT":"Fitness"}, axis=1)
    o=o.dropna(axis=0, how='any')
    outfile=infile.replace(".txt", "_GGTGGT.csv")
    o.to_csv(outdir+outfile, index=False)
    o=temp_tab[["AACombo", "TGGAGT"]]
    o=o.rename({"TGGAGT":"Fitness"}, axis=1)
    o=o.dropna(axis=0, how='any')
    outfile=infile.replace(".txt", "_TGGAGT.csv")
    o.to_csv(outdir+outfile, index=False)
